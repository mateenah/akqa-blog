...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(_default, [{
    ...
    value: function render() {
      ...
      var trail = this.props.someEntryAsProp.map(function (person) {
        return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(Col, {
          ...
          key: person.id,
          removePerson: _this.removePerson.bind(_this),
          person: person
        }));
      });
  ...
  return _default;
}(react__WEBPACK_IMPORTED_MODULE_10___default.a.Component); //  renderTrails = () => {
//   console.log("TRAILS", this.props.someEntryAsProp)
//   if(this.props.someEntryAsProp){
//     const trail= this.props.someEntryAsProp.map(t => {
//       return(
//         <div class="card text-white bg-success mb-3" >
//           <div class="card-header">{t.fields.title}</div>)}
//           <div class="card-body">
//             <h4 class="card-title" key="{t.fields.slug}">{t.fields.slug}</h4>
//             <p class="card-text" key="{t.fields.content}">{t.fields.content}</p>
//           </div> 
//         </div> 
//       )
//     })
...
//# sourceMappingURL=index.js.080e55967ecf57009755.hot-update.js.map