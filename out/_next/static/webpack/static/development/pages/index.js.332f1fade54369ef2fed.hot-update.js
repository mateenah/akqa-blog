...
var CheckMediaItem = function CheckMediaItem(_ref2) {
  ...
  //           <img src={dataCheck.fields.media && dataCheck.fields.media.fields.file.url} class="card-link" style= {divStyle}/>
  //       </div> 
  //     }else{
  //        <div class="card-body">
  //               <p class="card-text" key="{data.fields.content}">{data.fields.content}</p>
  //               {/* <a class="card-link" href={data.fields.mediaLink}>{data.fields.mediaLink}</a>  */}
  //               <div width="200" height="345" dangerouslySetInnerHTML={{ __html: data.fields.embedLink}} >
  //               </div>
  //             </div>
  //     }
  {
    data1.fields.media ? react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
      class: "card-body"
    }, react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("p", {
      class: "card-text",
      key: "{data1.fields.content}"
    }, data1.fields.content), react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("img", {
      src: data1.fields.media && data.fields.media.fields.file.url,
      key: "{data1.fields.media}",
      class: "card-link",
      style: divStyle
      ...
      class: "card-text",
      key: "{data1.fields.content}"
    }, data1.fields.content), react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
      width: "200",
      height: "345",
      key: "{data1.fields.embedLink}",
      dangerouslySetInnerHTML: {
        __html: data1.fields.embedLink
      }
    }));
  }
};
...
var ContentfulCard = function ContentfulCard(_ref3) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
    ...
    class: "row"
  }, _this.props.someEntryAsProp.map(function (data1) {
    return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(CheckMediaItem, {
      key: data1.id,
      data1: data1
    });
  }))));
...
//# sourceMappingURL=index.js.332f1fade54369ef2fed.hot-update.js.map