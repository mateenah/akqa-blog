...
var PeopleCard = function PeopleCard(_ref2) {
  ...
  return console.log('> person----', person) // <div class="card text-white bg-success mb-3" >
  //   <div class="card-header">{person.fields.title}</div>
  //   {/* <div class="card-body">
  //     <h4 class="card-title" key="{t.fields.slug}">{person.fields.slug}</h4>
  //     <p class="card-text" key="{t.fields.content}">{person.fields.content}</p>
  //   </div>  */}
  // </div> 
  ;
};
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(_default, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(_components_myLayout_js__WEBPACK_IMPORTED_MODULE_7__["default"], null, react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("h1", null, "My Blog"), react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("div", {
        ...
        class: "col-12 mb-3"
      }, this.props.someEntryAsProp.map(function (person) {
        return react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(PeopleCard, {
          key: person.id,
          person: person
        });
      }))));
  ...
  return _default;
}(react__WEBPACK_IMPORTED_MODULE_10___default.a.Component); //     render() {
// return (
//   <Layout>
//   <h1>My Blog</h1>
//   <div class="row">
//   <div class="col-12 mb-3">
//      {this.props.someEntryAsProp.map(person =>   
...
//# sourceMappingURL=index.js.ac9c6a925bd043e85484.hot-update.js.map